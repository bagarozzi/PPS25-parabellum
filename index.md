...
4. [**Design di dettaglio**](./docs/4-dettaglio.md)
5. [**Implementazione**](./docs/5-implementazione.md)
6. [**Testing**](./docs/6-testing.md)
7. [**Retrospettiva**](./docs/7-retrospettiva.md)

La documentazione del processo di sviluppo Agile/SCRUM è consulatibile presso [**Product Backlog**](./process/product_backlog.md)