...
| 27 | Soldier position generation |  | when soldiers are not in the same "zone" of the map | no |
...
| 30 | GameState update refactoring |  | . | no |
...
| 33 | Parser: adding logarithm and abs() functions |  | this | no |
